...
echo "Iniciando teste passo-a-passo do Wine bootstrap..."
...
echo "Configurando Wine para Windows 11..."
timeout 60s wine reg add "HKEY_CURRENT_USER\\Software\\Wine" /v Version /t REG_SZ /d win11 /f
...
echo "SUCESSO: Wine bootstrap validado. Nenhuma instalação do MT5 foi executada."
exit 0